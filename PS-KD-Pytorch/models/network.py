...
#--------------
from models import *
from models.resnet_bemyownteacher import multi_resnet18_kd, multi_resnet50_kd
...
def get_network(args):
    ...
    if args.data_type == 'cifar100':
        if args.classifier_type == 'PyramidNet':
            ...
            net = multi_resnet18_kd(num_classes=100)
        elif args.classifier_type == "ResNetBeMyOwnTeacher50":
            net = multi_resnet50_kd(num_classes=100)
        else:
